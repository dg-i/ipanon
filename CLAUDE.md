...
4. **Tests** — `pytest tests/` (272 tests across 6 test files)
5. **Test coverage verification** — Confirm all 6 test files are running: test_ranges (51), test_permutation (16), test_anonymizer (101), test_scanner (36), test_cli (41), test_networks (27)
